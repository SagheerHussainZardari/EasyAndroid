...
fun loginWithValidation(et_email: EditText,et_password: EditText,mAuth: FirebaseAuth,callBack: AuthCallBack) {
...
fun setDataInFirebaseRealtimeDatabase(path: DatabaseReference,value: String,callBack: RealtimeDatabaseCallBack) {
...
fun getDataFromFirebaseRealtimemDatabase(path: DatabaseReference,callBack: RealtimeDatabaseCallBack) {
